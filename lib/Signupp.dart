        ...
        body: Padding(
          ...
          child: Center(
            child: Column(children: [
              ...
              SizedBox(height: 80,),
              SizedBox(width:600, height:50,child: ElevatedButton(onPressed: (){}, child: Text("Sign up",style: TextStyle(fontSize: 20),),style: ElevatedButton.styleFrom(backgroundColor: Colors.blueAccent,foregroundColor: Colors.white),)),
              SizedBox(height: 80,),
              Padding(
